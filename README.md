...
By default, the `sample.py` script uses your trained model to sample 5 responses with maximum 100 tokens each and saves them in a json file called `sampled_sentences.json`, which you will submit the Gradescope. We will judge the quality of your sampled sentences based on whether they are at least somewhat coherent and grammatically correct.
